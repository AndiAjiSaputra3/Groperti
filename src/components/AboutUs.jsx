...
export default function AboutUs() {
    return (
        <div>
            <div id='about us' className='w-full pt-24'>
                <div class="grid lg:grid-cols-2">
                    ...
                    <div className='py-10 px-6 lg:w-5/6 text-justify'>
                        ...
                        <h1 className='font-bold text-2xl lg:text-3xl text-primary text-center'>Value We Give To You</h1>
                        ...
                        <div class="pt-2 ">
                            <div className="py-4 md:flex gap-5">
                                ...
                                <p className='text-dark-gray text-center lg:text-start'>Take advantage of our exclusive opportunities! Enjoy free promotions for your product or property at Groperti. With free registration, you can increase your visibility and grab the attention of more potential customers at no additional cost. Don't miss this opportunity to grow your business online.</p>
                            </div>
                            <div className="py-4 lg:flex gap-5">
                                <img src={iconAboutUs2} alt="" className='w-14 h-12 mx-auto lg:mx-0' />
                                <p className='text-dark-gray text-center lg:text-start'>Join the bartering revolution at Groperti! Exchange your products or properties for what you want without needing to use money. We open barter listing opportunities, allowing you to make mutually beneficial exchanges.</p>
                            </div>
                            <div className="py-4 lg:flex gap-5">
                                <img src={iconAboutUs3} alt="" className='w-14 h-12 mx-auto lg:mx-0' />
                                <p className='text-dark-gray text-center lg:text-start'>Gain mutual benefits at Groperti with our profit sharing program! We believe that success is the result of cooperation, therefore, we present the opportunity for you to share profits.</p>
                            </div>
