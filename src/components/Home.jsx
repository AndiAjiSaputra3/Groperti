...
export default function Home() {
    return (
        <div id='home' className='w-full py-10'>
            <div class="pt-14 lg:pt-20 grid lg:grid-cols-2 px-8 lg:px-28">
                <div className='m-auto'>
                    ...
                    <button className='bg-secondary text-white font-bold py-2.5 w-full md:w-48 rounded-lg hover:bg-dark-gray'>Get Started</button>
